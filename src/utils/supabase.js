...
const handleAuthStateChange = (event, session) => {
  switch (event) {
    case 'TOKEN_REFRESH_FAILED': console.warn('Supabase token refresh failed, clearing corrupted session data');
      clearCorruptedSessionData();
      break;
    
    case 'SIGNED_OUT': logger.info('User signed out, clearing session data');
      clearSessionData();
      break;
    
    case 'SIGNED_IN': logger.info('User signed in successfully');
      break;
    
    case 'TOKEN_REFRESHED': logger.info('Token refreshed successfully');
      break;
