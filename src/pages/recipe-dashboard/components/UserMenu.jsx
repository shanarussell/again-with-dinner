...
const UserMenu = ({ userProfile, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed top-16 right-4 z-50">
      <div 
        ref={menuRef}
        className="bg-white rounded-lg shadow-xl w-80 max-w-sm border border-gray-200 transform transition-all duration-200 ease-out"
      >
        ...
        <div className="py-2">
          <button
            onClick={() => handleMenuItemClick('/shopping-list')}
